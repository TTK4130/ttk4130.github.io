...
This assignment is meant as an introduction to mathematical modelling and
numerical integration. We will consider the mass-damper-spring system as shown
in the figure below.
