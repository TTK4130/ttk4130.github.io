...
.. admonition:: Tasks
    ...
    c) Using the expression in 1b), find the second order differential equation desribing
    the position of the mass :math:`x`. The spring is relaxed when the wagon is at the position :math:`x=0`.
