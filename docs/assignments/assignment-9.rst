...
Lastly, we have implemented the following torque limitation for the motor, as a function of the RPM, which approximates General Motor's 6.5TD (6.5 liter turbo diesel engine) from the 1990s.
...
.. admonition:: Task
    ...
    a.
        ...
        Fill in the state equations as indicated in the notebook.
        After this, run the simulator script to make a simulation and plot the states.
